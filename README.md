...
Steps:
1) NAP instances running on Kubernetes/Docker/VMs are configured to send their logs to Logstash.
2) Logstash tranforms the logs it ingests and store them on Elasticsearch indexes.
